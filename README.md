...
- [Agent Island](https://github.com/tristan666666/agent-island) - Open-source local status companion for Claude Code and Codex on macOS and Windows. The macOS app also shows Gemini CLI and Grok session state and tracks provider usage with Cursor support.
