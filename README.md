...
- [Orkas](https://github.com/Orkas-AI/Orkas) - Open-source local-first desktop workspace for orchestrating Claude Code, Codex CLI, OpenCode, OpenClaw, Hermes, and built-in agents in parallel with shared files and approval controls.
