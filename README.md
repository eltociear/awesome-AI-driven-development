...
- [Agent Island](https://github.com/tristan666666/agent-island) - Open-source local status companion for Claude Code, Codex, Antigravity, Grok and Cursor on macOS and Windows, with live session state, your-turn alerts, and locally computed usage and cost.
