...
- [Wayfinder](https://wayfinder-ai.pages.dev/) - Open-source local-first desktop app that organizes Codex and Claude Code session history into project-level voyage maps with branches, file changes, and validation.
