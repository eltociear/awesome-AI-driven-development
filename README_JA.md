...
- [Agent Island](https://github.com/tristan666666/agent-island) - macOSとWindowsに対応するClaude Code・Codex向けのオープンソースなローカルステータスコンパニオン。macOS版ではGemini CLI・Grokのセッション状態表示とCursorを含むプロバイダー使用量の追跡にも対応
